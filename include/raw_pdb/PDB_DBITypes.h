...
namespace libpdb
{
    ...
    namespace DBI
    {
        ...
        struct StreamHeader
        {
            ...
            enum class [[nodiscard]] Version : uint32_t{
                VC41 = 930803u, V50 = 19960307u, V60 = 19970606u, V70 = 19990903u, V110 = 20091201u,
            };
        ...
        {
            enum class [[nodiscard]] Version : uint32_t{ Ver60 = 0xeffe0000u + 19970605u, V2 = 0xeffe0000u + 20140516u };
    ...
    namespace CodeView
    {
        namespace DBI
        {
            ...
            enum class [[nodiscard]] ThunkOrdinal : uint8_t{
                NoType, ThisAdjustor, VirtualCall, PCode, DelayLoad, TrampolineIncremental, TrampolineBranchIsland,
            };

            enum class [[nodiscard]] TrampolineType : uint16_t{
                Incremental,
                BranchIsland,
            };

            // https://github.com/microsoft/microsoft-pdb/blob/master/include/cvinfo.h#L3038
            enum class [[nodiscard]] ProcedureFlags : uint8_t{
                None = 0u,
                NoFPO = 1u << 0u,
            ...
            enum class [[nodiscard]] PublicSymbolFlags : uint32_t{
                None = 0u,
            ...
            enum class [[nodiscard]] CompileSymbolFlags : uint32_t{ None = 0u,
            ...
            enum class [[nodiscard]] CPUType : uint16_t{
                Intel8080 = 0x0,   Intel8086 = 0x1,   Intel80286 = 0x2,     Intel80386 = 0x3,
                Intel80486 = 0x4,  Pentium = 0x5,     PentiumII = 0x6,      PentiumPro = PentiumII,
                PentiumIII = 0x7,  MIPS = 0x10,       MIPSR4000 = MIPS,     MIPS16 = 0x11,
                MIPS32 = 0x12,     MIPS64 = 0x13,     MIPSI = 0x14,         MIPSII = 0x15,
                MIPSIII = 0x16,    MIPSIV = 0x17,     MIPSV = 0x18,         M68000 = 0x20,
                M68010 = 0x21,     M68020 = 0x22,     M68030 = 0x23,        M68040 = 0x24,
                Alpha = 0x30,      Alpha21164 = 0x31, Alpha21164A = 0x32,   Alpha21264 = 0x33,
                Alpha21364 = 0x34, PPC601 = 0x40,     PPC603 = 0x41,        PPC604 = 0x42,
                PPC620 = 0x43,     PPCFP = 0x44,      PPCBE = 0x45,         SH3 = 0x50,
                SH3E = 0x51,       SH3DSP = 0x52,     SH4 = 0x53,           SHMedia = 0x54,
                ARM3 = 0x60,       ARM4 = 0x61,       ARM4T = 0x62,         ARM5 = 0x63,
                ARM5T = 0x64,      ARM6 = 0x65,       ARM_XMAC = 0x66,      ARM_WMMX = 0x67,
                ARM7 = 0x68,       Omni = 0x70,       IA64 = 0x80,          IA64_1 = 0x80,
                IA64_2 = 0x81,     CEE = 0x90,        AM33 = 0xA0,          M32R = 0xB0,
                TriCore = 0xC0,    X64 = 0xD0,        AMD64 = X64,          EBC = 0xE0,
                Thumb = 0xF0,      ARMNT = 0xF4,      ARM64 = 0xF6,         HybridX86ARM64 = 0xF7,
                ARM64EC = 0xF8,    ARM64X = 0xF9,     D3D11_Shader = 0x100,
            };

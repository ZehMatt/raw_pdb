...
namespace libpdb
{
    ...
    namespace IPI
    {
        ...
        struct StreamHeader
        {
            enum class [[nodiscard]] Version : uint32_t{ V40 = 19950410u, V41 = 19951122u, V50 = 19961031u, V70 = 19990903u,
                                                         V80 = 20040203u };
    ...
    namespace CodeView
    {
        namespace IPI
        {
            ...
            enum class [[nodiscard]] TypeRecordKind : uint16_t{
            ...
            enum class [[nodiscard]] BuildInfoType : uint8_t{
